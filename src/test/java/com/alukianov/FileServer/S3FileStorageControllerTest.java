...
import com.alukianov.FileServer.web.S3FileStorageController;
...
public class S3FileStorageControllerTest {

    @InjectMocks
    private S3FileStorageController fileStorageController;
